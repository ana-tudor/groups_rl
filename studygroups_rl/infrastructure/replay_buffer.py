...
class ReplayBuffer(object):
    ...
    def add_rollouts(self, paths, noised=False):
        ...
        for path in paths:
            tpath = dict()
            # print (path.keys())
            tpath['observation'] = path['observation']
            tpath['next_observation'] = path['next_observation']
            tpath['reward'] = path['reward']
            tpath['action'] = path['action']
            tpath['terminal'] = path['terminal']
